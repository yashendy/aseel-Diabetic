// js/food-items.js (fixed loading/errors)
...
const qEl = document.getElementById('q'), fCat = document.getElementById('fCat'),
      fSource = document.getElementById('fSource'), fPhoto = document.getElementById('fPhoto'),
      fSort = document.getElementById('fSort'), btnClear = document.getElementById('btnClear');
const btnAdd = document.getElementById('btnAdd'), togglePick = document.getElementById('togglePickMode');

const drawer = document.getElementById('drawer'), btnClose = document.getElementById('btnClose'),
      btnCancel = document.getElementById('btnCancel'), formTitle = document.getElementById('formTitle');

const form = document.getElementById('itemForm');
const itemId = document.getElementById('itemId'), nameEl = document.getElementById('name'),
      brandEl = document.getElementById('brand'), categoryEl = document.getElementById('category'),
      carb100El = document.getElementById('carb100'), prot100El = document.getElementById('prot100'),
      fat100El = document.getElementById('fat100'), kcal100El = document.getElementById('kcal100'),
      unitsList = document.getElementById('unitsList'), uNameEl = document.getElementById('uName'),
      uGramsEl = document.getElementById('uGrams'), btnAddUnit = document.getElementById('btnAddUnit'),
      imageUrlEl = document.getElementById('imageUrl'), btnAutoImage = document.getElementById('btnAutoImage'),
      tagsEl = document.getElementById('tags'), notesEl = document.getElementById('notes'),
      sourceEl = document.getElementById('source'), metaText = document.getElementById('metaText');

const snack = document.getElementById('snack'), snackText = document.getElementById('snackText'),
...
btnClear.addEventListener('click', ()=>{ qEl.value=''; fCat.value=''; fSource.value=''; fPhoto.value=''; fSort.value='name_asc'; renderGrid(); });

/* --- Auth + load --- */
showLoading();
let authTimer = setTimeout(()=>{
  // لو ما اتحسمتش حالة المستخدم خلال مهلة قصيرة بنوجه لصفحة الدخول
...
function renderGrid(){
  ...
  const cat=fCat.value, src=fSource.value, ph=fPhoto.value, sort=fSort.value;
  let arr=ITEMS.slice();
